...
public class ValidateAndReserveTResponse implements org.apache.thrift.TBase<ValidateAndReserveTResponse, ValidateAndReserveTResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ValidateAndReserveTResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ValidateAndReserveTResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new ValidateAndReserveTResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ValidateAndReserveTResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ValidateAndReserveTResponse.class, metaDataMap);
  }

  public ValidateAndReserveTResponse() {
  }
   ...
   */
  public ValidateAndReserveTResponse(ValidateAndReserveTResponse other) {
  ...
  public ValidateAndReserveTResponse deepCopy() {
    return new ValidateAndReserveTResponse(this);
  }
  ...
  public ValidateAndReserveTResponse setWorkerInfoList(List<WorkerInfo> workerInfoList) {
    this.workerInfoList = workerInfoList;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ValidateAndReserveTResponse)
      return this.equals((ValidateAndReserveTResponse)that);
    return false;
  }

  public boolean equals(ValidateAndReserveTResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ValidateAndReserveTResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ValidateAndReserveTResponse(");
    boolean first = true;
  ...
  private static class ValidateAndReserveTResponseStandardSchemeFactory implements SchemeFactory {
    public ValidateAndReserveTResponseStandardScheme getScheme() {
      return new ValidateAndReserveTResponseStandardScheme();
    }
  }

  private static class ValidateAndReserveTResponseStandardScheme extends StandardScheme<ValidateAndReserveTResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ValidateAndReserveTResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ValidateAndReserveTResponse struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ValidateAndReserveTResponseTupleSchemeFactory implements SchemeFactory {
    public ValidateAndReserveTResponseTupleScheme getScheme() {
      return new ValidateAndReserveTResponseTupleScheme();
    }
  }

  private static class ValidateAndReserveTResponseTupleScheme extends TupleScheme<ValidateAndReserveTResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ValidateAndReserveTResponse struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ValidateAndReserveTResponse struct) throws org.apache.thrift.TException {
